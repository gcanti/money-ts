...
export const prismNonZeroInteger = new Prism<number, NonZeroInteger>(
  n => (n !== 0 && n % 1 === 0 ? some(n as any) : none),
  nzi => nzi as any
)

export const fromInteger: (i: Integer) => Option<NonZeroInteger> = prismNonZeroInteger.getOption as any
...
export const add = (x: NonZeroInteger, y: NonZeroInteger): NonZeroInteger =>
  (prismNonZeroInteger.reverseGet(x) + prismNonZeroInteger.reverseGet(y)) as any
...
export const sub = (x: NonZeroInteger, y: NonZeroInteger): Option<NonZeroInteger> => {
  const r = prismNonZeroInteger.reverseGet(x) - prismNonZeroInteger.reverseGet(y)
